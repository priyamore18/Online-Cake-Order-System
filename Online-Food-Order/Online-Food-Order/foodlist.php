...
<html>
  ...
  <head>
    <title> Explore | PS Cake Shop </title>
  </head>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
      <img src="images/slide003.jpeg" style="width:100%;">
      <div class="carousel-caption">
      </div>
      </div>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Welcome To PS Cake Shop</h1>      
    <!--p>Let food be thy medicine and medicine be thy food</p-->
  </div>
</div>
<<div class="jumbotron">
  <div class="container text-center">
    <h1>Please order the cake before 1 hour</h1>      
    <!--p>Let food be thy medicine and medicine be thy food</p-->
  </div>
</div>
...
<h6 class="text-dark" style="font-size:20px">Available</h6>
