...
<html>
  ...
  <head>
    ...
    <title> Contact | PS Cake Shop</title>
  </head>
  ...
  <body>
    ...
    <script type="text/javascript">
        (function() {
            emailjs.init('_smPXwD_ChnpCG0Cb');
        })();
    </script>
    <script type="text/javascript">
      function sendEmail() {
                ...
                emailjs.sendForm('service_eimz07f', 'template_pqi3bh7', e.target, '_smPXwD_ChnpCG0Cb').then(res=>{console.log(res);
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> PS Cake Shop </span>?</strong>
     <br>
...
class="btn btn-success btn-primary pull-right" />  
        </form>
...
<footer class="container-fluid  text-center text-light navbar-dark bg-dark">
  <br>
 <p> PS CAKE SHOP 2022 | &copy All Rights Reserved </p>
 <br>
 </footer>
